...
public class Ch16_Ex03_JUpsideDownPanel extends JPanel implements ActionListener
{
   ...
   public Ch16_Ex03_JUpsideDownPanel()
   {
   ...
   public static void main(String[] args)
   {
        ...
        frame.add(new Ch16_Ex03_JUpsideDownPanel());
