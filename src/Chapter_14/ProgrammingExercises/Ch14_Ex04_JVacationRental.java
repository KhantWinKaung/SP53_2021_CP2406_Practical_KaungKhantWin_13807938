...
public class Ch14_Ex04_JVacationRental extends JFrame implements ItemListener
{
   ...
   String output;
   public Ch14_Ex04_JVacationRental()
   {
   ...
   {
      Ch14_Ex04_JVacationRental aFrame = new Ch14_Ex04_JVacationRental();
