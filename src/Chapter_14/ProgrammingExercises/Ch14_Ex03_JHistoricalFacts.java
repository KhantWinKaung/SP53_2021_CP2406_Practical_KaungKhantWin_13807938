...
public class Ch14_Ex03_JHistoricalFacts extends JFrame implements ActionListener
{
   ...
   int counter = 0;
   public Ch14_Ex03_JHistoricalFacts()
   {
      super("Facts");
   ...
   {
      Ch14_Ex03_JHistoricalFacts rFrame = new Ch14_Ex03_JHistoricalFacts();
