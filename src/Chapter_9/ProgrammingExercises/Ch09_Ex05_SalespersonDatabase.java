...
import java.util.*;
public class Ch09_Ex05_SalespersonDatabase
{
   public static void main(String[] args)
   {
      Ch09_Ex05_Salesperson[] salespeople = new Ch09_Ex05_Salesperson[20];
      int x;
      int id;
      int count = 0;
      double sales;
   ...
   public static int addOption(Ch09_Ex05_Salesperson[] array, int count)
   {
      Scanner keyboard = new Scanner(System.in);
      int id;
      double sales;
      ...
      else
      {
          ...
          if(!alreadyEntered)
          {
             ...
             array[count] = new Ch09_Ex05_Salesperson(id, sales);
             ++count;
          }
      }
      display(array, count);
   ...
   public static int deleteOption(Ch09_Ex05_Salesperson[] array, int count)
   {
      Scanner keyboard = new Scanner(System.in);
      int id;
      int position = 0;
   ...
   public static void changeOption(Ch09_Ex05_Salesperson[] array, int count)
   {
      Scanner keyboard = new Scanner(System.in);
      int position = 0;
      int id;
    ...
    public static void display(Ch09_Ex05_Salesperson[] array, int count)
    {
       int a,b;
