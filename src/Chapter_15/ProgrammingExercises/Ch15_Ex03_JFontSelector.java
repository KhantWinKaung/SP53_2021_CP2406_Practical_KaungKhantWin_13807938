...
public class Ch15_Ex03_JFontSelector extends JFrame implements ActionListener
{
   final int SMALL = 12;
   final int LARGE = 24;
   int size = SMALL;
   ...
   public Ch15_Ex03_JFontSelector()
   {
      setTitle("JFontFrame");
  ...
  {
     Ch15_Ex03_JFontSelector ff = new Ch15_Ex03_JFontSelector();
     ff.setSize(500, 180);
     ff.setVisible(true);
  }
}