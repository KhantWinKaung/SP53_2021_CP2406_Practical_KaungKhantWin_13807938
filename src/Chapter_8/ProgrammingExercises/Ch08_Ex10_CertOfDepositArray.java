...
import javax.swing.*;
import  java.time.*;
public class Ch08_Ex10_CertOfDepositArray
{
   public static void main(String[] args)
   {
      final int MAX = 5;
      Ch08_Ex10_CertOfDeposit[] certs = new Ch08_Ex10_CertOfDeposit[MAX];
      int x;
      String certNum;
      String name;
      double balance;
      ...
      for(x = 0; x < MAX; ++x)
      {
         ...
         certs[x] = new Ch08_Ex10_CertOfDeposit(certNum, name, balance, issueDate);
      }
      for(x = 0; x < MAX; ++x)
         display(certs[x], (x + 1));
   }
   public static void display(Ch08_Ex10_CertOfDeposit cd, int num)
   {
